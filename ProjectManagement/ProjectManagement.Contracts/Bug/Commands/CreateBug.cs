...
{
    public class CreateBug : ICreateIssue
    {
        public CreateBug(Guid projectId, string title, string description, Guid reporterId, Guid? assigneeId, ICollection<Guid> labelsIds)
        {
            ProjectId = projectId;
            Title = title;
    ...
    public class CreateBugValidator : AbstractValidator<CreateBug>
    {
